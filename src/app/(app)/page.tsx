  ...
  return (
    ...
    <main className="flex min-h-[80vh] flex-col items-center justify-center gap-4 py-4 px-6">
      <section className='text-center mb-8 md:mb-12'>
        <h1 className='text-2xl md:text-4xl font-bold' >Dive into the mystery world of Anonymous Conversations</h1>
    ...
    <footer className="w-full text-center py-4 bg-transparent text-gray-700 text-sm mt-auto">© 2026 Mystery Message. All rights reserved.</footer>
    </>
  )
}
